    ...
    public class EfCoreDbContextModelCreatingExtensionsGenerator : BaseDbCodeGenerator
    {
        ...
        private void AppendEntityMap(ICodeWriter writer, ClassModel clsInfo)
        {
            ...
            foreach (var property in clsInfo.Properties)
            {
                ...
                AppendEntityField(writer, property, clsInfo);
                i++;
            }
        ...
        private void AppendEntityField(ICodeWriter builder, PropertyModel property, ClassModel clsInfo)
        {
            ...
            {
                builder.Append($"                    .HasMaxLength({clsInfo.ClassName}Consts.Max{property.PropertyName}Length)");
                builder.AppendLine();
            }
